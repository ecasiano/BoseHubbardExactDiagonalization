...
# Non-sparse method (seems to work fine) 
#     # Initialize kinetic energy matrix
#     K = np.zeros((basis_size,basis_size))
...
#             K[m,n] = kinetic_element
#             K[n,m] = K[m,n] # Hermiticity of K
            
            #print("<",bra,"|K|",ket,"> = ",kinetic_element,ket_post)
    #print("\n")  
...
print("Done")
# print("A=",A)
# print("nearest_neighbor_pairs:",nearest_neighbor_pairs)
...
print("Done")
# print("K:",K)
# if np.array_equal(K,np.transpose(K)): print("K is Hermitian! \n")
# else: print("WARNING: K is not Hermitian! \n")
...
H = K+H_0
#np.fill_diagonal(H,H_0)
# print("\nL=%d, N=%d, t=%d, U = %d"%(L,N,t,U))
# print("Hamiltonian:")
# print(H)

#Find ground state energy and state of the Hamiltonian
print("(5/5)Diagonalizing H...")
#eigs,evecs = np.linalg.eigh(H) # NON-SPARSE VERSION
...
# header = "L = %d, N = %2d, lA = %d, t = %f, U = %f (Bosons)\nn      Pn"%(L,N,lA,t,U)
